      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-10 px-4 text-center">
        <div className="md:w-1/2">
          ...
          <p className="mb-4 text-gray-700">
            Nestled in the serene landscapes near the border of Canada, Hidden Heaven offers a captivating
            glamping experience unlike any other. Our retreat, situated in the heart of Washington state,
            invites all guests to immerse themselves in the beauty of nature while indulging in the comforts
            of luxury accommodation.
          </p>
        </div>
      </div>

      <div className="flex justify-center items-center gap-16 flex-wrap mt-16 px-4">

                            ...
                            <div className="flex flex-col items-start">
                                <div className="flex items-center">
                                    <img 
                                        src={treeIcon} 
                                        alt="Tree icon" 
                                        className={`w-16 h-10 ${TREE_COLOR_CLASS} object-contain`} 
                                    />
                                </div>
                        ...
                        <div className="mt-8 md:mt-0 md:w-1/3 lg:w-1/4 flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-bold text-gray-900 whitespace-nowrap">
                                    Write us on <a href="mailto:hidden.heaven@email.com" className={`hover:text-amber-700 transition ${EMAIL_COLOR_CLASS}`}>
                        ...
                        <div key={index} className="flex items-start">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2 flex items-center">
                                    {item.title}
                                    {item.tag && (
                                        <span className={`ml-3 text-xs font-bold uppercase py-1 px-2 rounded ${ACCENT_COLOR_CLASS} border ${ACCENT_BORDER_CLASS} bg-white`}>
                                            {item.tag}
                                        </span>
                                    )}
                                </h3>

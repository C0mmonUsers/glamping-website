    ...
    <section id="services" className="py-20">
      ...
      <div className="mt-20 flex flex-col md:flex-row items-stretch gap-6 px-4 md:px-12">
        <div className="md:w-1/2 w-full h-96 overflow-hidden">
          <img src={TENT} alt="Camping setup" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="md:w-2/3 w-full bg-green-50 flex items-center">
          <div className="w-full pl-6 md:pl-12 pr-6 py-8 text-left">
            ...
            <p className="text-gray-800 mb-6">
              Whether you're seeking a romantic getaway, a family adventure, or a solo escape,
              Hidden Heaven promises an unforgettable stay for every visitor. From cozy tents to
              charming cabins, our accommodations are thoughtfully designed to provide a tranquil
              haven amidst the breathtaking wilderness.
            </p>
      ...
      <div className="relative mt-20 mx-6 md:mx-12">
        <img src={vodopad} alt="Водопад" className="w-full h-auto rounded-xl" />
